...
/**
 * All the steps to restore mod_youtubewpt are defined here.
 *
...
/**
 * Defines the structure step to restore one mod_youtubewpt activity.
 */
class restore_youtubewpt_activity_structure_step extends restore_activity_structure_step {
